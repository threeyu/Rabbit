...
package com.modestmaps
{
	...
	import app.view.utils.MatrixUtil;
    ...
    public class Map extends Sprite
	{
	    ...
	    */
	    ...
	    public function Map(width:Number=320, height:Number=240, draggable:Boolean=true, mapProvider:IMapProvider=null, ... rest)
	    {
			...
			//var correctLayer:Shape = Tool.createShape(width, height, 0x1a1b1f);
			//correctLayer.alpha = 0.8;
		//	correctLayer.blendMode = BlendMode.ADD;
			//correctLayer.blendShader  = new Shader(Assets.createBinary("shaderColor")); 
			
			
			//addChild(correctLayer);
		

			
			grid.filters = [MatrixUtil.setSaturation(-60)
	   ...
	   /** Pan down by 1/3 (or panFraction) of the map height. */
		...
		{
			panAndZoomBy(17, location, targetPoint);
		}
