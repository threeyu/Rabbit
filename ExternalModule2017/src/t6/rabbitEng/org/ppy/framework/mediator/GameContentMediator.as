package t6.rabbitEng.org.ppy.framework.mediator
{
	...
	import t6.rabbitEng.org.ppy.framework.util.SoundData;
	import t6.rabbitEng.org.ppy.framework.util.SoundManager;
		...
		private function flip() : void
		{
			if(_mcCon)
			{
				...
				if(_pid != 4) {
					...
					view.mcHand().y =_mcCon["mcCon"]["mc_0"].y + 100;
				}
			}
		}
