package l1.zzl.rabbitFindDiff2
{
	...
	import l1.zzl.rabbitFindDiff2.common.BaseCommonExtModule;
	import l1.zzl.rabbitFindDiff2.util.SoundData;
	import l1.zzl.rabbitFindDiff2.util.SoundManager;
	
	/**
	 * 找不同
	 * @author puppy
	 * @time 2017-5-19 下午4:27:55
	 **/
	[SWF(backgroundColor="#000000", frameRate="30", width="1024", height="600")]
	public class RabbitFindDiff2Module extends BaseCommonExtModule
	{
		...
		public function RabbitFindDiff2Module()
		{
			super(new RabbitFindDiff2ModuleUI());
