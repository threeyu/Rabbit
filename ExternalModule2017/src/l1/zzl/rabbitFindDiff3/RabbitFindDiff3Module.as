package l1.zzl.rabbitFindDiff3
{
	...
	import l1.zzl.rabbitFindDiff3.common.BaseCommonExtModule;
	import l1.zzl.rabbitFindDiff3.util.SoundData;
	import l1.zzl.rabbitFindDiff3.util.SoundManager;
	

	/**
	 * 趣味大发现
	 * @author puppy
	 * @time 2017-5-18 上午11:33:21
	 **/
	[SWF(backgroundColor="#000000", frameRate="30", width="1024", height="600")]
	public class RabbitFindDiff3Module extends BaseCommonExtModule
	{
		...
		public function RabbitFindDiff3Module()
		{
			super(new RabbitFindDiff3ModuleUI());
