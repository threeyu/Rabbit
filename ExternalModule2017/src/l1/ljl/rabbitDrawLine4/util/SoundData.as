package l1.ljl.rabbitDrawLine4.util
{
	/**
	 * @author puppy
	...
	public class SoundData
	{
		...
		public static const ANS_SOUND : Array = [
			...
			["res/soundRight_2.mp3", "res/soundTips_2.mp3"],// 最后一个是title
			["res/soundRight_3.mp3", "res/soundTips_3.mp3"]// 最后一个是title
		];
		...
		public static const WRONG_SOUND : Array = [
			...
			["res/soundWrong_2.mp3"],
			["res/soundWrong_3.mp3"]
		];
