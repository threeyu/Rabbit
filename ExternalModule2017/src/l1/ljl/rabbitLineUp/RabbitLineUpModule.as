package l1.ljl.rabbitLineUp
{
	...
	import l1.ljl.rabbitLineUp.common.BaseCommonExtModule;
	import l1.ljl.rabbitLineUp.util.SoundData;
	import l1.ljl.rabbitLineUp.util.SoundManager;

	/**
	 * 火火兔连连看
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2017-6-7 上午9:56:02
	 **/
	[SWF(backgroundColor="#000000", frameRate="30", width="1024", height="600")]	
	public class RabbitLineUpModule extends BaseCommonExtModule
	{
		...
		public function RabbitLineUpModule()
		{
			super(new RabbitLineUpModuleUI());
