package l1.ljl.rabbitLineUp2
{
	...
	import l1.ljl.rabbitLineUp2.common.BaseCommonExtModule;
	import l1.ljl.rabbitLineUp2.util.SoundData;
	import l1.ljl.rabbitLineUp2.util.SoundManager;
	
	/**
	 * 情景连一连
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2017-6-7 下午4:04:31
	 **/
	[SWF(backgroundColor="#000000", frameRate="30", width="1024", height="600")]		
	public class RabbitLineUp2Module extends BaseCommonExtModule
	{
		...
		public function RabbitLineUp2Module()
		{
			super(new RabbitLineUp2ModuleUI());
