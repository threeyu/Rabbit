package l1.ljl.rabbitDrawLine3
{
	...
	import l1.ljl.rabbitDrawLine3.common.BaseCommonExtModule;
	import l1.ljl.rabbitDrawLine3.util.SoundData;
	import l1.ljl.rabbitDrawLine3.util.SoundManager;

	/**
	 * 小动物找食物
	 * @author puppy
	 * @time 2017-6-2 上午10:52:25
	 **/
	[SWF(backgroundColor="#000000", frameRate="30", width="1024", height="600")]	
	public class RabbitDrawLine3Module extends BaseCommonExtModule
	{
		...
		public function RabbitDrawLine3Module()
		{
			super(new RabbitDrawLine3ModuleUI());
