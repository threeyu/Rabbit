	...
	public class GameGateMediator_5 extends Mediator
	{
		...
		private function setType(id : uint) : uint
		{
			if(id == 0) {// 跑一次
				...
				soundPlay(soundData.getShapeTpesTips(_type));
			}
		...
		private function onIconHandler(e : MouseEvent) : void
		{
			...
			if(_iconInfoArr[_curIcon].type == _type) {// 正确形状
			...
			var scaleArr : Array = [4.5, 5, 4.6, 4, 2.6, 3, 4.2, 3.6];
