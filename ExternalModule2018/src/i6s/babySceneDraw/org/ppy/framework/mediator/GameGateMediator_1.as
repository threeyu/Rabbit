package i6s.babySceneDraw.org.ppy.framework.mediator
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-7-27 上午10:54:23
	 **/
	public class GameGateMediator_1 extends Mediator
	{
		[Inject]
		public var view : i6s.babySceneDraw.org.ppy.framework.view.GameGateView_1;
		
		[Inject]
		public var soundData : i6s.babySceneDraw.org.ppy.framework.model.SoundModel;
		...
		private const MAX_COLOR : uint = 30;
		...
		private function onIconHandler(e : MouseEvent) : void
		{
			...
			var scaleArr : Array = [1, 7, 4, 4, 7, 5];
