package extmodule.impl.rabbitDream
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-8 上午10:23:06
	 **/
	public class MyDreamModule3 extends BaseExtModule
	{
		[Inject]
		public var view : MyDreamView3;
		
		private var _soundRoot : String = "resource/sound/rabbitDream/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/myDreamModule3UI.swf";
		...
		public function MyDreamModule3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
...
//			trace("[sound]: sound/question" + levelNum + ".mp3");
		...
		private function gameStart() : void
		{
			for(var i : uint = 0; i < questionNum; i++) {
				...
				_mainUI["donghuaMc"+i].scaleX = .7;
				_mainUI["donghuaMc"+i].scaleY = .7;
