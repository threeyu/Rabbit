package extmodule.impl.rabbitCount
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-12 下午5:37:14
	 **/
	public class LikeCountingModule1 extends BaseExtModule
	{
		[Inject]
		public var view : LikeCountingView1;
		
		private var _soundRoot : String = "resource/sound/rabbitCount/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/likeCountingModule1UI.swf";
		...
		public function LikeCountingModule1()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
