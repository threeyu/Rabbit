package extmodule.impl.rabbitCount
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2019-2-20 上午11:03:00
	 **/
	public class LikeCountingModule3 extends BaseExtModule
	{
		[Inject]
		public var view : LikeCountingView3;
		
		private var _soundRoot : String = "resource/sound/rabbitCount/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/likeCountingModule3UI.swf";
		...
		public function LikeCountingModule3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
