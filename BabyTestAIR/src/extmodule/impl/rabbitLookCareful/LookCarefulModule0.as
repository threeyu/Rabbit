package extmodule.impl.rabbitLookCareful
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-30 上午10:40:44
	 **/
	public class LookCarefulModule0 extends BaseExtModule
	{
		[Inject]
		public var view : LookCarefulView0;
		
		private var _soundRoot : String = "resource/sound/rabbitLookCareful/";
		private var _bgm : String = "resource/sound/common/BGM_5.mp3";
		private var _url : String = "resource/extmodule/lookCarefulModule0UI.swf";
		...
		public function LookCarefulModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
