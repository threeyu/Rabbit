package extmodule.impl.rabbitBirthdayParty
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-22 下午4:19:29
	 **/
	public class BirthdayPartyModule2 extends BaseExtModule
	{
		[Inject]
		public var view : BirthdayPartyView2;
		
		private var _soundRoot : String = "resource/sound/rabbitBirthdayParty/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/birthdayPartyModule2UI.swf";
		...
		public function BirthdayPartyModule2()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
