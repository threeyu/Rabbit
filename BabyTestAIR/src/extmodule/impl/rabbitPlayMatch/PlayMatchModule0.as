package extmodule.impl.rabbitPlayMatch
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-28 下午6:21:45
	 **/
	public class PlayMatchModule0 extends BaseExtModule
	{
		[Inject]
		public var view : PlayMatchView0;
		
		private var _soundRoot : String = "resource/sound/rabbitPlayMatch/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/playMatchModule0UI.swf";
		...
		public function PlayMatchModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
