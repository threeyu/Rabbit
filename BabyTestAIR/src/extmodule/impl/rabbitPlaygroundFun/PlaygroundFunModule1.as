package extmodule.impl.rabbitPlaygroundFun
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-22 下午3:40:46
	 **/
	public class PlaygroundFunModule1 extends BaseExtModule
	{
		[Inject]
		public var view : PlaygroundFunView1;
		
		private var _soundRoot : String = "resource/sound/rabbitPlaygroundFun/";
		private var _bgm : String = "resource/sound/common/BGM_0.mp3";
		private var _url : String = "resource/extmodule/playgroundFunModule1UI.swf";
		...
		public function PlaygroundFunModule1()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
