package extmodule.impl.rabbitWardobe
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-10-17 下午5:47:18
	 **/
	public class WardobeModule0 extends BaseExtModule
	{
		[Inject]
		public var view : WardobeView0;
		
		private var _soundRoot : String = "resource/sound/rabbitWardobe/";
		private var _bgm : String = "resource/sound/common/BGM_0.mp3";
		private var _url : String = "resource/extmodule/wardobeModule0UI.swf";
		...
		public function WardobeModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
...
//			trace("[sound]: sound/question" + levelNum + ".mp3");
		...
		private function gameStart() : void
		{
			for(var i : uint = 0; i < questionNum; i++) {
				...
				_mainUI["donghuaMc"+i].scaleX = .6;
				_mainUI["donghuaMc"+i].scaleY = .6;
...
//							_mainUI["txtLog"].text = "11111111111111";
//							trace("[sound]: 答对了！");
...
//							_mainUI["txtLog"].text = "22222222222";
