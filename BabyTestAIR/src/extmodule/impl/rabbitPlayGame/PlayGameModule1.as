package extmodule.impl.rabbitPlayGame
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-8 下午6:39:28
	 **/
	public class PlayGameModule1 extends BaseExtModule
	{
		[Inject]
		public var view : PlayGameView1;
		
		private var _soundRoot : String = "resource/sound/rabbitPlayGame/";
		private var _bgm : String = "resource/sound/common/BGM_0.mp3";
		private var _url : String = "resource/extmodule/playGameModule1UI.swf";
		...
		public function PlayGameModule1()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
