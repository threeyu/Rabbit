package extmodule.impl.rabbitLikeWriting
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-30 下午4:43:29
	 **/
	public class LikeWritingModule0 extends BaseExtModule
	{
		[Inject]
		public var view : LikeWritingView0;
		
		private var _soundRoot : String = "resource/sound/rabbitLikeWriting/";
		private var _bgm : String = "resource/sound/common/BGM_4.mp3";
		private var _url : String = "resource/extmodule/likeWritingModule0UI.swf";
		...
		public var levelOneColorMcNum:Number=12;
		...
		public var needCossPointNumAry:Array=[11,20,11,29];
		...
		public function LikeWritingModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
