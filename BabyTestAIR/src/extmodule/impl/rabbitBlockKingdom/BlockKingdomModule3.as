package extmodule.impl.rabbitBlockKingdom
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-22 下午5:04:15
	 **/
	public class BlockKingdomModule3 extends BaseExtModule
	{
		[Inject]
		public var view : BlockKingdomView3;
		
		private var _soundRoot : String = "resource/sound/rabbitBlockKingdom/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/blockKingdomModule3UI.swf";
		...
		public function BlockKingdomModule3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
		...
		private function gameStart() : void
		{
			for(var i : uint = 0; i < questionNum; i++) {
				...
				_mainUI["donghuaMc"+i].scaleX = 1.3;
				_mainUI["donghuaMc"+i].scaleY = 1.3;
