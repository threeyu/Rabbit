package extmodule.impl.rabbitFillColor
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-22 下午4:57:26
	 **/
	public class FillColorShapeModule0 extends BaseExtModule
	{
		[Inject]
		public var view : FillColorShapeView0;
		
		private var _soundRoot : String = "resource/sound/rabbitFillColor/";
		private var _bgm : String = "resource/sound/common/BGM_3.mp3";
		private var _url : String = "resource/extmodule/fillColorShapeModule0UI.swf";
		...
		private var levelOneColorArray:Array=[[0xD503E8],[0xFFB7D0],[0xf1d300],[0xf27000],[0x6AD900],[0x00C7F1]];
		private var levelOneColorMcNum:Number=6;
		...
		public function FillColorShapeModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
