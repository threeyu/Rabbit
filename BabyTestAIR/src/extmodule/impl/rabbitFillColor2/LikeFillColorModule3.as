package extmodule.impl.rabbitFillColor2
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-23 上午9:41:00
	 **/
	public class LikeFillColorModule3 extends BaseExtModule
	{
		[Inject]
		public var view : LikeFillColorView3;
		
		private var _soundRoot : String = "resource/sound/rabbitFillColor2/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/likeFillColorModule3UI.swf";
		...
		private var levelFourColorArray:Array=[colorArray,colorArray,colorArray,colorArray];
		...
		public function LikeFillColorModule3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
