package extmodule.impl.rabbitRecycling
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-12 下午3:43:18
	 **/
	public class RecyclingModule3 extends BaseExtModule
	{
		[Inject]
		public var view : RecyclingView3;
		
		private var _soundRoot : String = "resource/sound/rabbitRecycling/";
		private var _bgm : String = "resource/sound/common/BGM_2.mp3";
		private var _url : String = "resource/extmodule/recyclingModule3UI.swf";
		...
		public function RecyclingModule3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
