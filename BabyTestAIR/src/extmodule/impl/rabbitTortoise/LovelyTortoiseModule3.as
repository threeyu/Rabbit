package extmodule.impl.rabbitTortoise
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-12 下午6:08:25
	 **/
	public class LovelyTortoiseModule3 extends BaseExtModule
	{
		[Inject]
		public var view : LovelyTortoiseView3;
		
		private var _soundRoot : String = "resource/sound/rabbitTortoise/";
		private var _bgm : String = "resource/sound/common/BGM_2.mp3";
		private var _url : String = "resource/extmodule/lovelyTortoiseModule3UI.swf";
		...
		public function LovelyTortoiseModule3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
...
//			trace("[sound]: 可爱的乌龟");
			...
			// 跳过引导动画
			TweenLite.delayedCall(4.5, tipsSoundCallback);
		}
...
//				_mainUI["donghuaMc"+i].scaleX = .75;
//				_mainUI["donghuaMc"+i].scaleY = .75;
