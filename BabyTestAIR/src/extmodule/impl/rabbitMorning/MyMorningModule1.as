package extmodule.impl.rabbitMorning
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-8 下午5:59:17
	 **/
	public class MyMorningModule1 extends BaseExtModule
	{
		[Inject]
		public var view : MyMorningView1;
		
		private var _soundRoot : String = "resource/sound/rabbitMorning/";
...
//			trace("[sound]: sound/question" + levelNum + ".mp3");
		...
		private function gameStart() : void
		{
			for(var i : uint = 0; i < questionNum; i++) {
				...
				_mainUI["donghuaMc"+i].scaleX = .45;
				_mainUI["donghuaMc"+i].scaleY = .45;
