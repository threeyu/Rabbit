package extmodule.impl.rabbitBusyWeekend
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-22 上午11:06:39
	 **/
	public class BusyWeekendModule1 extends BaseExtModule
	{
		[Inject]
		public var view : BusyWeekendView1;
		
		private var _soundRoot : String = "resource/sound/rabbitBusyWeekend/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/busyWeekendModule1UI.swf";
		...
		public function BusyWeekendModule1()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
