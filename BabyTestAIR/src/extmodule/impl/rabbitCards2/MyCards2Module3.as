package extmodule.impl.rabbitCards2
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-12 下午6:34:51
	 **/
	public class MyCards2Module3 extends BaseExtModule
	{
		[Inject]
		public var view : MyCards2View3;
		
		private var _soundRoot : String = "resource/sound/rabbitCards2/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/myCards2Module3UI.swf";
		...
		public function MyCards2Module3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
