package extmodule.impl.rabbitCards2
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2019-2-20 上午11:22:08
	 **/
	public class MyCards2Module1 extends BaseExtModule
	{
		[Inject]
		public var view : MyCards2View1;
		
		private var _soundRoot : String = "resource/sound/rabbitCards2/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/myCards2Module1UI.swf";
		...
		public function MyCards2Module1()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
