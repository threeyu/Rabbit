package extmodule.impl.rabbitFoodAssort
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-29 下午4:53:03
	 **/
	public class FoodAssortModule0 extends BaseExtModule
	{
		[Inject]
		public var view : FoodAssortView0;
		
		private var _soundRoot : String = "resource/sound/rabbitFoodAssort/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/foodAssortModule0UI.swf";
		...
		public function FoodAssortModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
