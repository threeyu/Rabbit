package extmodule.impl.rabbitFoodAssort
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2019-2-19 上午11:04:18
	 **/
	public class FoodAssortModule2 extends BaseExtModule
	{
		[Inject]
		public var view : FoodAssortView2;
		
		private var _soundRoot : String = "resource/sound/rabbitFoodAssort/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/foodAssortModule2UI.swf";
		...
		public function FoodAssortModule2()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
