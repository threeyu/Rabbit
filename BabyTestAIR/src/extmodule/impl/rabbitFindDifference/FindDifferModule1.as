package extmodule.impl.rabbitFindDifference
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-12 下午5:00:38
	 **/
	public class FindDifferModule1 extends BaseExtModule
	{
		[Inject]
		public var view : FindDifferView1;
		
		private var _soundRoot : String = "resource/sound/rabbitFindDifference/";
		private var _bgm : String = "resource/sound/common/BGM_2.mp3";
		private var _url : String = "resource/extmodule/findDifferModule1UI.swf";
		...
		public function FindDifferModule1()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
...
//			trace("[sound]: 哇哦，家里好多。。。");
			...
			TweenLite.delayedCall(6, tipsSoundCallback);
		}
