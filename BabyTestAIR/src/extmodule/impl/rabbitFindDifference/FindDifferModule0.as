package extmodule.impl.rabbitFindDifference
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2019-2-19 下午5:38:45
	 **/
	public class FindDifferModule0 extends BaseExtModule
	{
		[Inject]
		public var view : FindDifferView0;
		
		private var _soundRoot : String = "resource/sound/rabbitFindDifference/";
		private var _bgm : String = "resource/sound/common/BGM_2.mp3";
		private var _url : String = "resource/extmodule/findDifferModule0UI.swf";
		...
		public function FindDifferModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
