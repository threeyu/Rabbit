package extmodule.impl.rabbitManyShape
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-23 上午11:45:42
	 **/
	public class ManyShapeModule0 extends BaseExtModule
	{
		[Inject]
		public var view : ManyShapeView0;
		
		private var _soundRoot : String = "resource/sound/rabbitManyShape/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/manyShapeModule0UI.swf";
		...
		public function ManyShapeModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
