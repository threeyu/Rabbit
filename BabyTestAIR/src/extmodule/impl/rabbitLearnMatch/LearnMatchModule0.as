package extmodule.impl.rabbitLearnMatch
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-23 下午2:55:49
	 **/
	public class LearnMatchModule0 extends BaseExtModule
	{
		[Inject]
		public var view : LearnMatchView0;
		
		private var _soundRoot : String = "resource/sound/rabbitLearnMatch/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/learnMatchModule0UI.swf";
		...
		public function LearnMatchModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
