package extmodule.impl.rabbitLineUp
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-23 下午4:03:04
	 **/
	public class FindFoodModule0 extends BaseExtModule
	{
		[Inject]
		public var view : FindFoodView0;
		
		private var _soundRoot : String = "resource/sound/rabbitLineUp/";
		private var _bgm : String = "resource/sound/common/BGM_4.mp3";
		private var _url : String = "resource/extmodule/findFoodModule0UI.swf";
		...
		public function FindFoodModule0()
		{
			super(_url);
		}
		...
		private function gameStart() : void
		{
			...
			_mainUI["mcLvl_0"]["mcSrc_0"].x = 142.8;
			_mainUI["mcLvl_0"]["mcSrc_0"].y = 495.35;
			_mainUI["mcLvl_0"]["mcSrc_1"].x = 896.05;
			_mainUI["mcLvl_0"]["mcSrc_1"].y = 522.3;
