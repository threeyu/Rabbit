package extmodule.impl.rabbitToyBrick
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-12 下午2:56:40
	 **/
	public class ToyBrickModule0 extends BaseExtModule
	{
		[Inject]
		public var view : ToyBrickView0;
		
		private var _soundRoot : String = "resource/sound/rabbitToyBrick/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/toyBrickModule0UI.swf";
		...
		public function ToyBrickModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
