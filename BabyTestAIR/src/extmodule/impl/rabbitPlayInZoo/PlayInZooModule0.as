package extmodule.impl.rabbitPlayInZoo
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-29 上午11:51:06
	 **/
	public class PlayInZooModule0 extends BaseExtModule
	{
		[Inject]
		public var view : PlayInZooView0;
		
		private var _soundRoot : String = "resource/sound/rabbitPlayInZoo/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/playInZooModule0UI.swf";
		...
		public function PlayInZooModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
