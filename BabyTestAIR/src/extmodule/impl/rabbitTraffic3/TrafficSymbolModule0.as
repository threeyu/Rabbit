package extmodule.impl.rabbitTraffic3
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-21 下午3:09:09
	 **/
	public class TrafficSymbolModule0 extends BaseExtModule
	{
		[Inject]
		public var view : TrafficSymbolView0;
		
		private var _soundRoot : String = "resource/sound/rabbitTraffic3/";
		private var _bgm : String = "resource/sound/common/BGM_2.mp3";
		private var _url : String = "resource/extmodule/trafficSymbolModule0UI.swf";
		...
		public function TrafficSymbolModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
