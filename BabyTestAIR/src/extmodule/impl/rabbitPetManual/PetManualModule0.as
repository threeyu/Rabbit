package extmodule.impl.rabbitPetManual
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-23 下午3:37:10
	 **/
	public class PetManualModule0 extends BaseExtModule
	{
		[Inject]
		public var view : PetManualView0;
		
		private var _soundRoot : String = "resource/sound/rabbitPetManual/";
		private var _bgm : String = "resource/sound/common/BGM_2.mp3";
		private var _url : String = "resource/extmodule/petManualModule0UI.swf";
		
		
		//答案的预设数组
		private var answerKeyArray:Array=[["小 狗","狗"],["乌 龟"],["鱼"],["二","两"],["三"],["四"],["小 狗","狗"],["小 兔 子","兔 子"],["小 猫","猫"],["蜜 蜂"],["山 羊","羊"],["蜗 牛"]];
		...
		public function PetManualModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
		...
		private function titleSoundCallback() : void
		{
			...
			TweenMax.delayedCall(8, tipsSoundCallback);
		}
