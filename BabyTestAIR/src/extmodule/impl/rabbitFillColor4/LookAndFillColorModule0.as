package extmodule.impl.rabbitFillColor4
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-23 上午11:12:13
	 **/
	public class LookAndFillColorModule0 extends BaseExtModule
	{
		[Inject]
		public var view : LookAndFillColorView0;
		
		private var _soundRoot : String = "resource/sound/rabbitFillColor4/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/lookAndFillColorModule0UI.swf";
		...
		private var levelOneColorArray:Array=[[0xf1d300],[0x00C7F1],[0x6AD900],[0xf40008]];
		private var levelOneColorMcNum:Number=4;
		...
		public function LookAndFillColorModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
		...
		private function titleSoundCallback() : void
		{
			...
			TweenLite.delayedCall(13, tipsSoundCallback);
		}
		...
		private function gameStart() : void
		{
			...
			initFun(levelOneColorMcNum,levelOneColorArray);
		}
		...
		private function initFun(colormc:Number,colorary:Array):void
		{
			...
			for(var j:uint=0;j<colormc;j++){
				...
				levelScene["colorMc"+j].wrongSound="level"+levelNum+"Wrong"+j+".mp3";
