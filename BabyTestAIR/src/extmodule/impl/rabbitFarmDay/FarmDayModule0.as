package extmodule.impl.rabbitFarmDay
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-29 下午5:48:31
	 **/
	public class FarmDayModule0 extends BaseExtModule
	{
		[Inject]
		public var view : FarmDayView0;
		
		private var _soundRoot : String = "resource/sound/rabbitFarmDay/";
		private var _bgm : String = "resource/sound/common/BGM_4.mp3";
		private var _url : String = "resource/extmodule/farmDayModule0UI.swf";
		...
		public function FarmDayModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
		...
		private function gameStart() : void
		{
			for(var i : uint = 0; i < questionNum; i++) {
				...
				_mainUI["donghuaMc"+i].scaleX = .8;
				_mainUI["donghuaMc"+i].scaleY = .8;
