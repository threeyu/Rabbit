package extmodule.impl.rabbitTraffic2
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-21 上午10:45:34
	 **/
	public class TrafficKnowModule1 extends BaseExtModule
	{
		[Inject]
		public var view : TrafficKnowView1;
		
		private var _soundRoot : String = "resource/sound/rabbitTraffic2/";
		private var _bgm : String = "resource/sound/common/BGM_2.mp3";
		private var _url : String = "resource/extmodule/trafficKnowModule1UI.swf";
		...
		public function TrafficKnowModule1()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
