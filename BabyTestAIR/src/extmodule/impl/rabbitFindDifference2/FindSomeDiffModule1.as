package extmodule.impl.rabbitFindDifference2
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-27 下午7:07:11
	 **/
	public class FindSomeDiffModule1 extends BaseExtModule
	{
		[Inject]
		public var view : FindSomeDiffView1;
		
		private var _soundRoot : String = "resource/sound/rabbitFindDifference2/";
		private var _bgm : String = "resource/sound/common/BGM_5.mp3";
		private var _url : String = "resource/extmodule/findSomeDiffModule1UI.swf";
		...
		public function FindSomeDiffModule1()
		{
			super(_url);
		}
		...
		private function onItemClick(e : MouseEvent) : void
		{
			...
			if(_itemFlagList[_curLvl - 1][id] == false)
			{
				...
				soundManager.stopSoundExpect(_bgm);
				soundManager.playSound(_soundRoot + "sound_3.mp3");
				checkWin();
			}
		}
