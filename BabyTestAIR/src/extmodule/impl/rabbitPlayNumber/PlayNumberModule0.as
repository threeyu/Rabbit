package extmodule.impl.rabbitPlayNumber
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-30 下午3:01:10
	 **/
	public class PlayNumberModule0 extends BaseExtModule
	{
		[Inject]
		public var view : PlayNumberView0;
		
		private var _soundRoot : String = "resource/sound/rabbitPlayNumber/";
		private var _bgm : String = "resource/sound/common/BGM_6.mp3";
		private var _url : String = "resource/extmodule/playNumberModule0UI.swf";
		...
		public function PlayNumberModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
