package extmodule.impl.rabbitToys2
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-23 上午11:31:30
	 **/
	public class FindMyToysModule0 extends BaseExtModule
	{
		[Inject]
		public var view : FindMyToysView0;
		
		private var _soundRoot : String = "resource/sound/rabbitToys2/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/findMyToysModule0UI.swf";
		...
		public function FindMyToysModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
