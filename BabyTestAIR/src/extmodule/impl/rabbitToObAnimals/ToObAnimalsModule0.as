package extmodule.impl.rabbitToObAnimals
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-29 下午5:14:10
	 **/
	public class ToObAnimalsModule0 extends BaseExtModule
	{
		[Inject]
		public var view : ToObAnimalsView0;
		
		private var _soundRoot : String = "resource/sound/rabbitToObAnimals/";
		private var _bgm : String = "resource/sound/common/BGM_6.mp3";
		private var _url : String = "resource/extmodule/toObAnimalsModule0UI.swf";
		...
		public function ToObAnimalsModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
