package extmodule.impl.rabbitFunFarm
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-29 下午6:25:21
	 **/
	public class FunFarmModule0 extends BaseExtModule
	{
		[Inject]
		public var view : FunFarmView0;
		
		private var _soundRoot : String = "resource/sound/rabbitFunFarm/";
		private var _bgm : String = "resource/sound/common/BGM_2.mp3";
		private var _url : String = "resource/extmodule/funFarmModule0UI.swf";
		
		
		//答案的预设数组
		private var answerKeyArray:Array=[["小 狗","狗"],["小 猪","猪","母 猪"],["羊","山 羊","绵 羊"],["小 鸡","公 鸡","鸡"],["牛","母 牛","公 牛"],["鸭","鸭 子"],["樱 桃","车 厘 子"],["胡 萝 卜","红 萝 卜"],["葡 萄"],["葡 萄","红 葡 萄","紫 葡 萄"],["西 红 柿","番 茄"],["豌 豆","青 豆"]];
		...
		public function FunFarmModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
