package extmodule.impl.rabbitPatternAround
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-7 下午6:21:03
	 **/
	public class PatternAroundModule3 extends BaseExtModule
	{
		[Inject]
		public var view : PatternAroundView3;
		
		private var _soundRoot : String = "resource/sound/rabbitPatternAround/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/patternAroundModule3UI.swf";
		...
		public function PatternAroundModule3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
...
//			trace("[sound]: 身边的图案");
			...
			TweenLite.delayedCall(3, titleSoundCallback);
		}
...
//			trace("[sound]: 哇哦，家里好多。。。");
			...
			TweenLite.delayedCall(9, tipsSoundCallback);
		}
