package extmodule.impl.rabbitNumberWorld
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-30 下午3:20:21
	 **/
	public class NumberWorldModule0 extends BaseExtModule
	{
		[Inject]
		public var view : NumberWorldView0;
		
		private var _soundRoot : String = "resource/sound/rabbitNumberWorld/";
		private var _bgm : String = "resource/sound/common/BGM_3.mp3";
		private var _url : String = "resource/extmodule/numberWorldModule0UI.swf";
		...
		public function NumberWorldModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
		...
		private function gameStart() : void
		{
			for(var i : uint = 0; i < questionNum; i++) {
				...
				_mainUI["donghuaMc"+i].scaleX = 1.8;
				_mainUI["donghuaMc"+i].scaleY = 1.8;
