package extmodule.impl.rabbitMaganaHouse
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-22 上午10:36:57
	 **/
	public class MaganaHouseModule1 extends BaseExtModule
	{
		[Inject]
		public var view : MaganaHouseView1;
		
		private var _soundRoot : String = "resource/sound/rabbitMaganaHouse/";
		private var _bgm : String = "resource/sound/common/BGM_2.mp3";
		private var _url : String = "resource/extmodule/maganaHouseModule1UI.swf";
		...
		public function MaganaHouseModule1()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
