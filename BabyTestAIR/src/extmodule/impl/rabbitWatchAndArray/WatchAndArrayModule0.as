package extmodule.impl.rabbitWatchAndArray
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-29 上午10:03:02
	 **/
	public class WatchAndArrayModule0 extends BaseExtModule
	{
		[Inject]
		public var view : WatchAndArrayView0;
		
		private var _soundRoot : String = "resource/sound/rabbitWatchAndArray/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/watchAndArrayModule0UI.swf";
		...
		public function WatchAndArrayModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
