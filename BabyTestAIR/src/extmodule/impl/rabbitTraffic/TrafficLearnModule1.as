package extmodule.impl.rabbitTraffic
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-21 上午10:05:31
	 **/
	public class TrafficLearnModule1 extends BaseExtModule
	{
		[Inject]
		public var view : TrafficLearnView1;
		
		private var _soundRoot : String = "resource/sound/rabbitTraffic/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/trafficLearnModule1UI.swf";
		...
		public function TrafficLearnModule1()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
