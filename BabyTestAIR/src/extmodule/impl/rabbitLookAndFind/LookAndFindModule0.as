package extmodule.impl.rabbitLookAndFind
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-22 下午2:47:26
	 **/
	public class LookAndFindModule0 extends BaseExtModule
	{
		[Inject]
		public var view : LookAndFindView0;
		
		private var _soundRoot : String = "resource/sound/rabbitLookAndFind/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/lookAndFindModule0UI.swf";
		...
		public function LookAndFindModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
