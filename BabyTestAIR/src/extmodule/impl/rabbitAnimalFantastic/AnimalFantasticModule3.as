package extmodule.impl.rabbitAnimalFantastic
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-21 下午5:41:30
	 **/
	public class AnimalFantasticModule3 extends BaseExtModule
	{
		[Inject]
		public var view : AnimalFantasticView3;;
		
		private var _soundRoot : String = "resource/sound/rabbitAnimalFantastic/";
		private var _bgm : String = "resource/sound/common/BGM_0.mp3";
		private var _url : String = "resource/extmodule/animalFantasticModule3UI.swf";
		...
		public function AnimalFantasticModule3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
		...
		private function titleSoundCallback() : void
		{
			...
			TweenLite.delayedCall(11, tipsSoundCallback);
		}
		...
		private function gameStart() : void
		{
			for(var i : uint = 0; i < questionNum; i++) {
				...
				_mainUI["donghuaMc"+i].scaleX = .38;
				_mainUI["donghuaMc"+i].scaleY = .38;
