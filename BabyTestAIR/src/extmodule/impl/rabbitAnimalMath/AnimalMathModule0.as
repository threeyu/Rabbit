package extmodule.impl.rabbitAnimalMath
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-21 下午4:53:47
	 **/
	public class AnimalMathModule0 extends BaseExtModule
	{
		[Inject]
		public var view : AnimalMathView0;
		
		private var _soundRoot : String = "resource/sound/rabbitAnimalMath/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/animalMathModule0UI.swf";
		...
		public function AnimalMathModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
