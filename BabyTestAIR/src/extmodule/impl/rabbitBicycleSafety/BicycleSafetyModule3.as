package extmodule.impl.rabbitBicycleSafety
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-21 下午2:25:19
	 **/
	public class BicycleSafetyModule3 extends BaseExtModule
	{
		[Inject]
		public var view : BicycleSafetyView3;
		
		private var _soundRoot : String = "resource/sound/rabbitBicycleSafety/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/bicycleSafetyModule3UI.swf";
		...
		public function BicycleSafetyModule3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
