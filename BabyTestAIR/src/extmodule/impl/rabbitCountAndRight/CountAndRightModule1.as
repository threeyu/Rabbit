package extmodule.impl.rabbitCountAndRight
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2019-2-19 下午4:17:44
	 **/
	public class CountAndRightModule1 extends BaseExtModule
	{
		[Inject]
		public var view : CountAndRightView1;
		
		private var _soundRoot : String = "resource/sound/rabbitCountAndRight/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/countAndRightModule1UI.swf";
		...
		public function CountAndRightModule1()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
