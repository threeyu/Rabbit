package extmodule.impl.rabbitCountAndRight
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2019-2-19 下午4:19:02
	 **/
	public class CountAndRightModule3 extends BaseExtModule
	{
		[Inject]
		public var view : CountAndRightView3;
		
		private var _soundRoot : String = "resource/sound/rabbitCountAndRight/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/countAndRightModule3UI.swf";
		...
		public function CountAndRightModule3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
