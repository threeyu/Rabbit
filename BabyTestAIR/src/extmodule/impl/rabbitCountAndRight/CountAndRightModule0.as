package extmodule.impl.rabbitCountAndRight
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-30 上午11:47:17
	 **/
	public class CountAndRightModule0 extends BaseExtModule
	{
		[Inject]
		public var view : CountAndRightView0;
		
		private var _soundRoot : String = "resource/sound/rabbitCountAndRight/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/countAndRightModule0UI.swf";
		...
		public function CountAndRightModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
