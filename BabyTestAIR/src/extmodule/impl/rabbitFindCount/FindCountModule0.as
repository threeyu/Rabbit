package extmodule.impl.rabbitFindCount
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-29 下午6:12:53
	 **/
	public class FindCountModule0 extends BaseExtModule
	{
		[Inject]
		public var view : FindCountView0;
		
		private var _soundRoot : String = "resource/sound/rabbitFindCount/";
		private var _bgm : String = "resource/sound/common/BGM_3.mp3";
		private var _url : String = "resource/extmodule/findCountModule0UI.swf";
		...
		public function FindCountModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
