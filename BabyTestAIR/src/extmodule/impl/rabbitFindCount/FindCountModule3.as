package extmodule.impl.rabbitFindCount
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2019-2-19 下午3:25:03
	 **/
	public class FindCountModule3 extends BaseExtModule
	{
		[Inject]
		public var view : FindCountView3;
		
		private var _soundRoot : String = "resource/sound/rabbitFindCount/";
		private var _bgm : String = "resource/sound/common/BGM_3.mp3";
		private var _url : String = "resource/extmodule/findCountModule3UI.swf";
		...
		public function FindCountModule3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
