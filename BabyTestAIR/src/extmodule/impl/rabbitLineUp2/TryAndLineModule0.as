package extmodule.impl.rabbitLineUp2
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-26 下午3:16:44
	 **/
	public class TryAndLineModule0 extends BaseExtModule
	{
		[Inject]
		public var view : TryAndLineView0;
		
		private var _soundRoot : String = "resource/sound/rabbitLineUp2/";
		private var _bgm : String = "resource/sound/common/BGM_5.mp3";
		private var _url : String = "resource/extmodule/tryAndLineModule0UI.swf";
		...
		public function TryAndLineModule0()
		{
			super(_url);
		}
...
//								_soundManager.playSound(SoundData.ANS_SOUND[_curLvl - 1][_curPlayId]);
							soundManager.playSound(_soundRoot + "soundRight_" + (_curPlayId + 1) + ".mp3");
...
//								_soundManager.playSound(SoundData.WRONG_SOUND[_curLvl - 1][i]);
							soundManager.playSound(_soundRoot + "soundWrong_1.mp3");
		...
		{
			TweenLite.delayedCall(6.5, function():void{
				_mainUI["mcMov"]["mc"].gotoAndStop(1);
				_mainUI["mcMov"].gotoAndStop(1);
				_mainUI["mcMov"].visible = false;
