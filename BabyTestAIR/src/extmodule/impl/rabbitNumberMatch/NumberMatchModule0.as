package extmodule.impl.rabbitNumberMatch
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-30 下午4:04:46
	 **/
	public class NumberMatchModule0 extends BaseExtModule
	{
		[Inject]
		public var view : NumberMatchView0;
		
		private var _soundRoot : String = "resource/sound/rabbitNumberMatch/";
		private var _bgm : String = "resource/sound/common/BGM_3.mp3";
		private var _url : String = "resource/extmodule/numberMatchModule0UI.swf";
		...
		public function NumberMatchModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
