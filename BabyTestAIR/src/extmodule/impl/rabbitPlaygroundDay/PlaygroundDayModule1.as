package extmodule.impl.rabbitPlaygroundDay
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-22 下午3:14:01
	 **/
	public class PlaygroundDayModule1 extends BaseExtModule
	{
		[Inject]
		public var view : PlaygroundDayView1;
		
		private var _soundRoot : String = "resource/sound/rabbitPlaygroundDay/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/playgroundDayModule1UI.swf";
		...
		public function PlaygroundDayModule1()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
		...
		private function gameStart() : void
		{
			for(var i : uint = 0; i < questionNum; i++) {
				...
				_mainUI["donghuaMc"+i].scaleX = .5;
				_mainUI["donghuaMc"+i].scaleY = .5;
