package extmodule.impl.rabbitHandwork
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-12 下午3:32:48
	 **/
	public class MyHandwordModule3 extends BaseExtModule
	{
		[Inject]
		public var view : MyHandwordView3;
		
		private var _soundRoot : String = "resource/sound/rabbitHandwork/";
		private var _bgm : String = "resource/sound/common/BGM_2.mp3";
		private var _url : String = "resource/extmodule/myHandwordModule3UI.swf";
		...
		public function MyHandwordModule3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
