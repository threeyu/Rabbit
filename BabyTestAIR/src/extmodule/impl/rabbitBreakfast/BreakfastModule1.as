package extmodule.impl.rabbitBreakfast
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-8 下午5:39:24
	 **/
	public class BreakfastModule1 extends BaseExtModule
	{
		[Inject]
		public var view : BreakfastView1;
		
		private var _soundRoot : String = "resource/sound/rabbitBreakfast/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/breakfastModule1UI.swf";
		...
		public function BreakfastModule1()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
...
//			trace("[sound]: sound/question" + levelNum + ".mp3");
		...
		private function gameStart() : void
		{
			for(var i : uint = 0; i < questionNum; i++) {
				...
				_mainUI["donghuaMc"+i].scaleX = .69;
				_mainUI["donghuaMc"+i].scaleY = .69;
