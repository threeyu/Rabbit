package extmodule.impl.rabbitBalloon
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-7 下午2:26:53
	 **/
	public class BalloonModule1 extends BaseExtModule
	{
		[Inject]
		public var view : BalloonView1;
		
		private var _soundRoot : String = "resource/sound/rabbitBalloon/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/balloonModule1UI.swf";
		...
		public function BalloonModule1()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
