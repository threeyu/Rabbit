package extmodule.impl.rabbitPlayAndCount
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2019-2-20 下午2:49:33
	 **/
	public class PlayCountModule1 extends BaseExtModule
	{
		[Inject]
		public var view : PlayCountView1;
		
		private var _soundRoot : String = "resource/sound/rabbitPlayAndCount/";
		private var _bgm : String = "resource/sound/common/BGM_0.mp3";
		private var _url : String = "resource/extmodule/playCountModule1UI.swf";
		...
		public function PlayCountModule1()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
