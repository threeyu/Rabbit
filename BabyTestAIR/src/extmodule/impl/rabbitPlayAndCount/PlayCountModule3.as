package extmodule.impl.rabbitPlayAndCount
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-12 下午6:58:59
	 **/
	public class PlayCountModule3 extends BaseExtModule
	{
		[Inject]
		public var view : PlayCountView3;
		
		private var _soundRoot : String = "resource/sound/rabbitPlayAndCount/";
		private var _bgm : String = "resource/sound/common/BGM_0.mp3";
		private var _url : String = "resource/extmodule/playCountModule3UI.swf";
		...
		public function PlayCountModule3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
...
//				_mainUI["donghuaMc"+i].scaleX = 2;
//				_mainUI["donghuaMc"+i].scaleY = 2;
