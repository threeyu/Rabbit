package extmodule.impl.rabbitCards
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-12 上午11:47:16
	 **/
	public class MyCardsModule3 extends BaseExtModule
	{
		[Inject]
		public var view : MyCardsView3;
		
		private var _soundRoot : String = "resource/sound/rabbitCards/";
		private var _bgm : String = "resource/sound/common/BGM_0.mp3";
		private var _url : String = "resource/extmodule/myCardsModule3UI.swf";
		...
		public function MyCardsModule3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
