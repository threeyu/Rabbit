package extmodule.impl.rabbitSortNumber
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2019-2-20 下午4:07:12
	 **/
	public class SortNumberModule0 extends BaseExtModule
	{
		[Inject]
		public var view : SortNumberView0;
		
		private var _soundRoot : String = "resource/sound/rabbitSortNumber/";
		private var _bgm : String = "resource/sound/common/BGM_0.mp3";
		private var _url : String = "resource/extmodule/sortNumberModule0UI.swf";
		...
		public function SortNumberModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
