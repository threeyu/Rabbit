package extmodule.impl.rabbitSortNumber
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2019-2-20 下午4:19:49
	 **/
	public class SortNumberModule2 extends BaseExtModule
	{
		[Inject]
		public var view : SortNumberView2;
		
		private var _soundRoot : String = "resource/sound/rabbitSortNumber/";
		private var _bgm : String = "resource/sound/common/BGM_0.mp3";
		private var _url : String = "resource/extmodule/sortNumberModule2UI.swf";
		...
		public function SortNumberModule2()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
