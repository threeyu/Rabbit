package extmodule.impl.rabbitObservedBoy
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-28 下午6:06:19
	 **/
	public class ObservedBoyModule0 extends BaseExtModule
	{
		[Inject]
		public var view : ObservedBoyView0;
		
		private var _soundRoot : String = "resource/sound/rabbitObservedBoy/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/observedBoyModule0UI.swf";
		...
		public function ObservedBoyModule0()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
