package extmodule.impl.rabbitTraffic4
{
	 ...
	 * @author: puppy
	 * @version: 1.0
	 * @time: 2018-11-21 下午3:39:31
	 **/
	public class TrafficColorModule3 extends BaseExtModule
	{
		[Inject]
		public var view : TrafficColorView3;
		
		private var _soundRoot : String = "resource/sound/rabbitTraffic4/";
		private var _bgm : String = "resource/sound/common/BGM_1.mp3";
		private var _url : String = "resource/extmodule/trafficColorModule3UI.swf";
		...
		private var levelFourColorArray:Array=[[0xf40008],[0xf40008],[0x6ad900],[0x6ad900]];
		private var levelFourColorMcNum:Number=4;
		...
		public function TrafficColorModule3()
		{
			trace("----- 添加场景 -----");
			super(_url);
		}
...
//			trace("[sound]: 交通中的颜色");
			...
			TweenLite.delayedCall(4, titleSoundCallback);
		}
...
//			trace("[sound]: 今天是周末。。。");
			...
			TweenLite.delayedCall(12, tipsSoundCallback);
		}
